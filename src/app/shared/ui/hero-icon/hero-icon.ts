...
// Mapeo de nombres de iconos a sus paths SVG de Heroicons (24x24 outline)
const iconPaths: Record<string, string> = {
  ...
  'hexagon': '<path stroke-linecap="round" stroke-linejoin="round" d="M12 2.25v6m0 0v6m0-6h6m-6 0H6m6 6h6m-6 0v6m0-6H6m6 6v6m0 0h6m-6 0H6m6-6H6m6 6v-6m0 6h6M6 2.25h12A1.75 1.75 0 0 1 19.75 4v16A1.75 1.75 0 0 1 18 21.75H6A1.75 1.75 0 0 1 4.25 20V4A1.75 1.75 0 0 1 6 2.25Z"/>',
  'chat-bubble-left-right': '<path stroke-linecap="round" stroke-linejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 0 1-.825-.242m9.345-8.334a2.126 2.126 0 0 0-.476-.095 48.64 48.64 0 0 0-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0 0 11.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155"/><path stroke-linecap="round" stroke-linejoin="round" d="M6 18a3 3 0 0 1-3-3V9a3 3 0 0 1 3-3h.75m0 0H9m-3 0H6m0 0v3m0-3v3m0 0h.75M6 9h.75M6 9v3m0 0h.75m-3 0H6m3 0v3m0-3h.75M9 9h.75M9 9v3m0 0h.75"/>',
  ...
  'palette': '<path stroke-linecap="round" stroke-linejoin="round" d="M12 3c-5.247 0-9 3.758-9 7.5 0 3.314 2.686 6 6 6h.75a2.25 2.25 0 0 1 2.25 2.25c0 .966.784 1.75 1.75 1.75A7.5 7.5 0 0 0 20.5 13c0-5.523-3.477-10-8.5-10Z"/><path stroke-linecap="round" stroke-linejoin="round" d="M8.5 12a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Zm5-6a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm5 4a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm0 6a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"/>',
  ...
  'wrench-screwdriver': '<path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655-5.653a2.548 2.548 0 0 1 0-3.586l2.12-2.12a2.548 2.548 0 0 1 3.586 0l5.653 4.655a2.548 2.548 0 0 1 0 3.586l-2.12 2.12a2.548 2.548 0 0 1-3.586 0Z"/>',
};
